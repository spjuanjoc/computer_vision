/**
* @brief Declares the global logger objects.
*
* @author  spjuanjoc
* @date    2021-03-25
*/
...
public:
  ...
  /**
   * Delete the special members. Non-copy, non-movable.
   */
  ...
  /**
   * @brief Enables the file sink logger that creates the directory and rotating files.
   */
  void enableFileSink();
